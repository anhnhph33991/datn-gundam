...
@section('style')
<link href="{{ asset('assets/theme/admin/libs/bootstrap-rating/bootstrap-rating.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('content')
<div class="row">
    <div class="col-12">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img src="{{ Storage::url($comment->user->avatar) }}" alt="{{ $comment->user->name }}" width="30px" height="30px">
                                    @else
                                    <img src="https://laravel.com/img/logomark.min.svg" alt="" style="height: 30px; width: 30px">
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="rating-star">
                                        <input type="hidden" class="rating" data-filled="mdi mdi-star text-warning" data-empty="mdi mdi-star-outline text-muted" data-readonly value="{{ $comment->rating }}" />
                                    </div>
                                </td>
                            </tr>
                            @endforeach
